...
public class Fuse : MonoBehaviour
{
    ...
    // i fusibili devono avere il capsule collider con is trigger attivo e un rigidbody senza gravità
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        // Mostra canvas e consenti interazione solo se almeno uno è preso
